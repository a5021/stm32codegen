...
if __name__ == '__main__':
    ...
    if args.peripheral:
        ...
        stout = f'{n}/* This code was generated by the stm32cgen python 3 '\
                f'script for the {args.cpu} microcontroller.'\
    ...
    elif len(sys.argv) < 5 and args.cpu != '' and args.main_module:
        xp = {}
        ...
        for x in xp:
            ...
            if func_name not in f_list:
                ...
                if ('gpio' == func_name) or ('rcc' == func_name):
                    pass
                else:
