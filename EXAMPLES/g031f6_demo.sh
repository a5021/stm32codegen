...
if [[ ! -z "${WSL_INTEROP}" ]]; then
    ...
    echo "Running under MinGW environment"
    python_interpreter=python
...
# Check for Debian
    ...
    echo "Running under a Unix-like environment"
    python_interpreter=python3
fi
...
py_gen="env $python_interpreter $PY_GEN/stm32cgen.py"
...
tag=R
$py_gen -l g031f6 -p RCC -m rcc -f init_rcc\
    \
    -D $tag '(HCLK >= 12)'\
...
$py_gen -l g031f6 -p GPIOA GPIOB GPIOF -m gpio -f init_gpio\
    ...
    -H ")"\
    -H ""\
    -H "#define GPIOB_MODE                     PIN_MODE(0,  PIN_MODE_OUTPUT)"\
    -H "#define GPIOB_OSPEEDR                  PIN_SPEED(0, PIN_SPEED_HIGH)"\
    -H ""\
...
/Td6WFoAAATm1rRGAgAhARYAAAB0L+Wj4BRPCHtdABGIBQgxtnU5LikPV1IlBndbIkGoimb05iJr
...

EOF`"


create_file "stm32g031xx_flash.ld" "`cat << EOF

Tp7GkuEGAAHeCbAgAACJw07DscRn+wIAAAAABFla
EOF
`"
...
__STATIC_FORCEINLINE void process_systick_event(void) {
  ...
  GPIOB->BSRR = ++*uptime() & (1 << 9) ? BS(0) : BR(4);
...
#
#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Include/stm32g0xx.h
#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Include/stm32g031xx.h
#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Include/system_stm32g0xx.h

#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Source/Templates/system_stm32g0xx.c
#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Source/Templates/gcc/startup_stm32g031xx.s
#    https://raw.githubusercontent.com/STMicroelectronics/cmsis-device-g0/refs/heads/master/Source/Templates/arm/startup_stm32g031xx.s    
#
...
#    https://raw.githubusercontent.com/ARM-software/CMSIS_5/refs/heads/develop/CMSIS/Core/Include/cmsis_armcc.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_5/refs/heads/develop/CMSIS/Core/Include/cmsis_armclang.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_5/refs/heads/develop/CMSIS/Core/Include/core_cm0.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_5/refs/heads/develop/CMSIS/Core/Include/core_cm0plus.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_5/refs/heads/develop/CMSIS/Core/Include/mpu_armv7.h
#
...
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/core_cm0plus.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/cmsis_armcc.h
#
#    https://raw.githubusercontent.com/cmsis-svd/cmsis-svd-data/refs/heads/main/data/STMicro/STM32G030.svd
...
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/m-profile/cmsis_armclang_m.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/m-profile/cmsis_clang_m.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/m-profile/cmsis_gcc_m.h
#    https://raw.githubusercontent.com/ARM-software/CMSIS_6/main/CMSIS/Core/Include/m-profile/cmsis_iccarm_m.h
...
fname3=("cmsis_compiler.h" "cmsis_armclang.h" "cmsis_gcc.h" "cmsis_version.h" "core_cm0plus.h" "cmsis_armcc.h" "mpu_armv7.h")
