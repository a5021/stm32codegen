...
<Project xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="project_projx.xsd">
  ...
  <Targets>
    <Target>
      ...
      <TargetOption>
        <TargetCommonOption>
          <Device>STM32G031F8Px</Device>
          <Vendor>STMicroelectronics</Vendor>
          <Cpu>IRAM(0x20000000,0x00002000) IROM(0x08000000,0x00010000) CPUTYPE("Cortex-M0+") CLOCK(16000000) ELITTLE</Cpu>
          ...
          <Cads>
            ...
            <VariousControls>
              <MiscControls>-Wpedantic -Wextra</MiscControls>
               <Define>STM32G031xx DEBUG</Define>
              <Undefine></Undefine>
      ...
      <Groups>
        <Group>
          ...
          <Files>
            ...
            <File>
              <FileName>startup_stm32g031xx.s</FileName>
              <FileType>2</FileType>
              <FilePath>..\MDK-ARM\startup_stm32g031xx.s</FilePath>
            </File>
            <File>
      ...
      <TargetOption>
        ...
        <TargetArmAds>
          ...
          <Cads>
            ...
            <VariousControls>
              <MiscControls>-Wpedantic -Wextra</MiscControls>
               <Define>NDEBUG,STM32G031xx</Define>
              <Undefine></Undefine>
              <IncludePath>../inc</IncludePath>
            </VariousControls>
          </Cads>
