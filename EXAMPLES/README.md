...
The generated output folders (`f103c8_demo/`, `f030f4_demo/`, `f103c8t6_demo/`,
`g031f8_demo/`) are build artifacts produced by running the matching script;
they are **not** checked into the repository. Re-run a script to regenerate.
