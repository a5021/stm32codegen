...
| `g070rb_demo.sh`      | STM32G070RB       | Generic G070RB board, **PC8** | Cortex-M0+, 64 MHz HSE | HSE 8 MHz + PLL ×16 (÷2); flash WS auto-configured; LED active LOW; here-doc embedded files |
...
`g070rb_demo/`, `f401cc_demo/`, `f303vc_demo/`, `f407vg_demo/`, `f446re_demo/`,
`g431cb_demo/`, `l152rb_demo/`) are build artifacts produced by running the
