...
#define PIN_SPEED(PIN, SPEED)          (((SPEED) << GPIO_OSPEEDR_OSPEED ## PIN ## _Pos) & GPIO_OSPEEDR_OSPEED ## PIN ## _Msk)
#define PIN_OTYPE(PIN, OTYPE)          ((OTYPE)   ? GPIO_OTYPER_OT ## PIN : 0)
#define PIN_PUPD(PIN, PUPD)            (((PUPD)  << GPIO_PUPDR_PUPD ## PIN ## _Pos) & GPIO_PUPDR_PUPD ## PIN ## _Msk)
...
#define _ODR(PIN)                      GPIO_ODR_OD ## PIN
...
//  Arguments used:
//    -l g031f8 -p GPIOA -m gpio -f init_gpio -D
...
//    "(((MODE)  << GPIO_MODER_MODE ## PIN ## _Pos) & GPIO_MODER_MODE ## PIN ## _Msk)"
//    "PIN_SPEED(PIN, SPEED)" "(((SPEED) << GPIO_OSPEEDR_OSPEED ## PIN ## _Pos) &
//    GPIO_OSPEEDR_OSPEED ## PIN ## _Msk)" "PIN_OTYPE(PIN, OTYPE)" "((OTYPE)   ?
//    GPIO_OTYPER_OT ## PIN : 0)" "PIN_PUPD(PIN, PUPD)" "(((PUPD)  << GPIO_PUPDR_PUPD
//    ## PIN ## _Pos) & GPIO_PUPDR_PUPD ## PIN ## _Msk)" "PIN_AF(PIN, AF)" "(AF <<
//    (PIN * 4))" "" PA0_AF1_USART1_CTS "PIN_AF(0, 1ULL)" PA1_AF0_EVENTOUT "PIN_AF(1,
//    0ULL)" PA1_AF1_USART1_RTS "PIN_AF(1, 1ULL)" PA2_AF1_USART1_TX "PIN_AF(2, 1ULL)"
//    PA3_AF1_USART1_RX "PIN_AF(3, 1ULL)" PA4_AF0_SPI1_NSS "PIN_AF(4, 0ULL)"
//    PA4_AF1_USART1_CK "PIN_AF(4, 1ULL)" PA4_AF4_TIM14_CH1 "PIN_AF(4, 4ULL)"
//    PA5_AF0_SPI1_SCK "PIN_AF(5, 0ULL)" PA6_AF0_SPI1_MISO "PIN_AF(6, 0ULL)"
//    PA6_AF1_TIM3_CH1 "PIN_AF(6, 1ULL)" PA6_AF2_TIM1_BKIN "PIN_AF(6, 2ULL)"
//    PA6_AF5_TIM16_CH1 "PIN_AF(6, 5ULL)" PA6_AF6_EVENTOUT "PIN_AF(6, 6ULL)"
//    PA7_AF0_SPI1_MOSI "PIN_AF(7, 0ULL)" PA7_AF1_TIM3_CH2 "PIN_AF(7, 1ULL)"
//    PA7_AF2_TIM1_CH1N "PIN_AF(7, 2ULL)" PA7_AF4_TIM14_CH1 "PIN_AF(7, 4ULL)"
//    PA7_AF5_TIM17_CH1 "PIN_AF(7, 5ULL)" PA7_AF6_EVENTOUT "PIN_AF(7, 6ULL)"
//    PA9_AF1_USART1_TX "PIN_AF(9, 1ULL)" PA9_AF2_TIM1_CH2 "PIN_AF(9, 2ULL)"
//    PA9_AF4_I2C1_SCL "PIN_AF(9, 4ULL)" PA10_AF0_TIM17_BKIN "PIN_AF(10, 0ULL)"
//    PA10_AF1_USART1_RX "PIN_AF(10, 1ULL)" PA10_AF2_TIM1_CH3 "PIN_AF(10, 2ULL)"
//    PA10_AF4_I2C1_SDA "PIN_AF(10, 4ULL)" PA13_AF0_SWDIO "PIN_AF(13, 0ULL)"
//    PA13_AF1_IR_OUT "PIN_AF(13, 1ULL)" PA14_AF0_SWCLK "PIN_AF(14, 0ULL)"
//    PA14_AF1_USART1_TX "PIN_AF(14, 1ULL)" "" PIN_TYPE_PP 0x00UL PIN_TYPE_OD 0x01UL
//    "" PIN_SPEED_LOW 0x00UL PIN_SPEED_MED 0x01UL PIN_SPEED_HIGH 0x03UL ""
//    PIN_PUPD_NONE 0x00UL PIN_PUPD_UP 0x01UL PIN_PUPD_DOWN 0x02UL "" _BR(PIN)
//    "GPIO_BSRR_BR ## PIN" BR(PIN) _BR(PIN) _BS(PIN) "GPIO_BSRR_BS ## PIN" BS(PIN)
//    _BS(PIN) _ODR(PIN) "GPIO_ODR_OD ## PIN" ODR(PIN) _ODR(PIN) "" GPIOA_MODER
//    "(GPIO_MODE ^ (GPIOA_MODE))" "" GPIOA_AFR_0 "(GPIOA_AF & UINT32_MAX)"
//    GPIOA_AFR_1 "((GPIOA_AF >> 32) & UINT32_MAX)" -H "" -H "#define
...
//    | \" -H "  SWD_EN    * PA14_AF0_SWCLK                  \" -H ) --force-inline
//    --no-def
////////////////////////////////////////////////////////////////////////////////////////
